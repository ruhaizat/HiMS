						...
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>No Inbois</th>
                                    <th>Tarikh Inbois<br></th>
                                    <th>No. Kelompok<br></th>
            ...
            <?php
              ...
              <tr <?php if($i%2==0){echo 'class="even"';}else{echo'class="odd"';}?>>
                 <!-- <td><?php echo $i; ?></td>-->
                  ...
                  <td><?php $query = $this->db->query("SELECT GROUP_CONCAT(nama_kelompok SEPARATOR ', ') AS val FROM tbl_kelompok WHERE kod_kelompok IN (".$data['no_kelompok'].");"); echo $query->row()->val; ?></td>
                  <td><?php $query = $this->db->query("SELECT COUNT(id) AS val FROM tbl_pendeposit WHERE kod_kelompok IN(".$data['no_kelompok'].");"); echo $query->row()->val; ?></td>
                 
                
                    
                  <td><a href="<?php echo site_url('Admin/Invoice/edit_data/'. $data['id'].''); ?>" class="btn btn-primary btn-xs">Kemaskini</a>           
                <!--  <a href="<?php echo site_url('Admin/Invoice/delete_data/'. $data['id'].''); ?>" class="btn btn-danger btn-xs">Hapus</a></td>-->
              </tr>
                <?php
                    $i++;
                      }
