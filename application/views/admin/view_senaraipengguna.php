            ...
            <?php
              ...
              <tr <?php if($i%2==0){echo 'class="even"';}else{echo'class="odd"';}?>>
                 <!-- <td><?php echo $i; ?></td>-->
                  ...
                  <td><a href="<?php echo site_url('Admin/SenaraiPengguna/edit_data/'. $data['id'].''); ?>" class="btn btn-primary btn-xs">Kemaskini</a>           
                  <a href="<?php echo site_url('Admin/SenaraiPengguna/delete_data/'. $data['id'].''); ?>" class="btn btn-danger btn-xs">Hapus</a></td>
              </tr>
                <?php
                    $i++;
                      }
