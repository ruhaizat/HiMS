						...
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>ID Pengguna</th>
                                    <th>Nama Pengguna<br></th>
                                    <th>Emel<br></th>
                                    <th>No Telefon Bimbit<br></th>
                                    <th>Organisasi<br></th>
                                    <th>Status<br></th>
            ...
            <?php
              ...
              <tr <?php if($i%2==0){echo 'class="even"';}else{echo'class="odd"';}?>>
                 <!-- <td><?php echo $i; ?></td>-->
                  ...
                  <td><?php echo $data['no_tel_bimbit']; ?></td>
                  <td><?php echo $data['kod_organisasi']; ?></td>
                  <td><?php echo $data['kod_sts_pengguna']; ?></td>
                
                    
                  <td><a href="<?php echo site_url('Admin/Pengguna/edit_data/'. $data['id'].''); ?>" class="btn btn-primary btn-xs">Kemaskini</a>           
                <!--  <a href="<?php echo site_url('Admin/Pengguna/delete_data/'. $data['id'].''); ?>" class="btn btn-danger btn-xs">Hapus</a></td>-->
              </tr>
                <?php
                    $i++;
                      }
