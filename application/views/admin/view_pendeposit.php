        ...
        <button class="btn leftBorderNone" type="button"><i class="glyphicon glyphicon-calendar"></i></button>
            ...
            <?php
              ...
              <tr <tr <?php if($i%2==0){echo 'class="even"';}else{echo'class="odd"';}?>>
                  ...
                  <td><a href="<?php echo site_url('Admin/Pendeposit/edit_data/'. $data['pendepositid'].''); ?>" class="btn btn-primary btn-xs">Kemaskini</a>           
                <a href="<?php echo site_url('Admin/Pendeposit/view_imbasan/'. $data['pendepositid'].''); ?>" class="btn btn-danger btn-xs">Imbasan</a></td>
              </tr>
                <?php
                    $i++;
                      }
